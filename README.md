...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Nagam Swathi </p>
    <p><strong>Email ID:</strong> swathinagam350@gmail.com </p>
    <p><strong>College Name:</strong> JNTUA </p>
    <p><strong>Branch/Specialization :</strong> MBA(BDA) </p>
    <p><strong>College ID:</strong> 240A1E0425 </p>
</div>
...
During this course, I learned the fundamentals of data analytics and data science. I gained hands-on experience with Python, SQL,python libraries and Data Visualization while strengthening my skills in statistical analysis, data cleaning, documentation, and delivering data-driven solutions to real-world problems.

<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project 1:</a></strong> Loan Approval Prediction </p>


</div>

<!-- Project 1 -->
<h3 id="project1">Project 1: Loan Approval Prediction </h3>
<p>
Banks and financial institutions receive a large number of loan applications every day. Manually checking each application is time-consuming and may lead to human errors or biased decisions.

This project focuses on building a Loan Approval Prediction system using machine learning techniques. The model analyzes applicant details such as income, credit history, loan amount, employment status, and marital status to predict whether a loan should be approved or rejected.
...
During my internship period, I participated in multiple community-oriented activities .....During my internship, I actively participated in community-oriented initiatives to foster social welfare and environmental consciousness. These activities helped me develop a sense of civic duty and highlighted the importance of contributing to the common good alongside my professional growth.

### **Activities Involved**
>
- **Tree Plantation Drive** – Participated by planting trees and contributing to environmental improvement.

  Tree Plantation Drive – Participated in a green initiative at Anantapur by planting native saplings and spreading awareness about environmental sustainability and the local ecosystem.
...
<div align="center">
<img src="https://github.com/sure-trust/NAGAM-SWATHI-g7-ds/blob/19ac35d94cbfd197a544ef71fc33fe3b0a60ba01/Final%20capstone%20project/community%20service%201.jpeg" width="30%">
...
I would like to express my sincere gratitude to everyone who supported and guided me throughout my internship and project work. This journey has been a valuable learning experience that helped me grow both technically and personally.

I am deeply thankful to my trainer Mr Bhargavesh Dakka sir for their continuous guidance, encouragement, and valuable insights during the internship. I would also like to extend my heartfelt thanks to Prof. Radha Kumari Ma'am Directore of SURE Trust PreEd for her constant support, motivation, and mentorship, which played a crucial role in the successful completion of my project. Their guidance, along with the exposure gained through Life Skill Training (LST), Soft Skill Training (SST), and community service activities, made this internship a truly enriching experience
